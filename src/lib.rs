...
pub fn suitable_macro_derive(input: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        ...
        impl #impl_generics Suitability for #name #ty_generics #where_clause where #(#types: Debug + Suitability),* {
